...
const TRY_ON_SECTIONS = [
  {
    ...
    items: [
      ...
      "ご試着プランはご自宅での利用に限らせて頂きます。屋外利用や写真撮影・パーティー利用・イベントでのご着用等、ご試着以外のご利用はNGとなります",
    ],
  },
  {
    title: "「ご試着プラン」特典",
  ...
  },
  {
    ...
    items: [
      ...
      "ご試着はご自宅利用のみとさせていただきます。屋外や写真撮影・パーティー利用・イベントでのご着用等、ご試着以外のご利用が発覚した場合、またタグを外してご試着をされた場合、定価を申し受けます",
      "ご試着プランではご延長はできません",
